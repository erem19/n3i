...
<body>
   ...
   if (isset($_GET['p'])) {
    ...
    echo ('
<nav class="navbar navbar-light" style="background-color: #19d1fa;">
  <div class="navbar-brand">
  <a href="?"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5T-13g1MWWHufeGaxuqo5SyeqRf3DQOU9vQ&s" width="30" height="30" alt=""></a>
');
...
<a href="?upload&q=' . urlencode(encodePath(PATH)) . '"><button class="btn btn-dark" type="button">Upload your file</button></a>
